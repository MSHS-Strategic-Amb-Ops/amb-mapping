...
amb_mapping_prov <- amb_mapping %>%
  dplyr::select(SITE, DEPT_SPECIALTY_NAME, DEPARTMENT_NAME, DEPARTMENT_ID, Department_Clean, PROV_NAME, PROV_NAME_WID, NPI, PROV_ID, DEP_RPT_GRP_ELEVEN)

last_arrived_prov <- last_arrived %>%
  group_by(SITE, DEPT_SPECIALTY_NAME, DEPARTMENT_NAME, DEPARTMENT_ID, PROV_NAME_WID, NPI, LAST_ARRIVED_PROV) %>%
  summarise(total = n())
...
amb_mapping_prov <- amb_mapping_prov %>%
  ...
  rename(CAMPUS = SITE,
         CAMPUS_SPECIALTY = DEPT_SPECIALTY_NAME) %>%
  arrange(CAMPUS, CAMPUS_SPECIALTY) %>%
  dplyr::select(CAMPUS, CAMPUS_SPECIALTY, DEPARTMENT_NAME, Department_Clean, DEPARTMENT_ID, DEP_RPT_GRP_ELEVEN, PROV_NAME, PROV_NAME_WID, NPI, PROV_ID, PROV_TYPE, TKT_SCH_YN, LAST_ARRIVED_PROV)
