...
amb_mapping <- access_raw_tbl %>%
  group_by(SITE, DEPT_SPECIALTY_NAME, DEPARTMENT_NAME, DEPARTMENT_ID, DEP_RPT_GRP_ELEVEN, PROV_NAME_WID, NPI) %>%
  summarise(total = n()) %>%
  collect()
...
amb_mapping_prov <- amb_mapping %>%
  dplyr::select(SITE, DEPT_SPECIALTY_NAME, DEPARTMENT_NAME, DEPARTMENT_ID, Department_Clean, PROV_NAME, NPI, DEP_RPT_GRP_ELEVEN)
...
amb_mapping_prov <- amb_mapping_prov %>%
  ...
  rename(CAMPUS = SITE,
         CAMPUS_SPECIALTY = DEPT_SPECIALTY_NAME) %>%
  arrange(CAMPUS, CAMPUS_SPECIALTY) %>%
  dplyr::select(CAMPUS, CAMPUS_SPECIALTY, DEPARTMENT_NAME, Department_Clean, DEPARTMENT_ID, DEP_RPT_GRP_ELEVEN, PROV_NAME, NPI, LAST_ARRIVED_PROV)
