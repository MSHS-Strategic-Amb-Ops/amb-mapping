...
amb_mapping_prov <- amb_mapping_prov %>%
  ...
  rename(CAMPUS = SITE,
         CAMPUS_SPECIALTY = DEPT_SPECIALTY_NAME) %>%
  arrange(CAMPUS, CAMPUS_SPECIALTY) %>%
  dplyr::select(CAMPUS, CAMPUS_SPECIALTY, DEPARTMENT_NAME, Department_Clean, DEPARTMENT_ID, DEP_RPT_GRP_ELEVEN, PROV_NAME, NPI, PROV_ID, TKT_SCH_YN, LAST_ARRIVED_PROV)
